...
p1 <- ggplot(de_df %>% arrange(desc(FDR)), aes(logCPM, log2FoldChange, color=DE)) +
  geom_point(alpha=0.8, size=1) +
  scale_color_manual(values=c("forestgreen", "red", "grey80")) +
  my_theme()
p2 <- ggplot(de_df %>% arrange(desc(Annotation)), aes(logCPM, log2FoldChange, color=Annotation)) +
  geom_point(alpha=0.8, size=1) +
